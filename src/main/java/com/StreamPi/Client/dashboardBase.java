...
public abstract class dashboardBase extends BorderPane {
    ...
    void setCurrentStatus(String textMessage, ConnectionStatus connectionStatus)
    {
        connectionStatusLabel.setText(textMessage);
        if(connectionStatus == ConnectionStatus.NOT_CONNECTED) connectionStatusLabel.setTextFill(Color.RED);
        else connectionStatusLabel.setTextFill(Color.GREEN);
    }
    ...
    public void setConnectionStatus(String message, boolean status)
    {
        //Sets Status of connection of the client
